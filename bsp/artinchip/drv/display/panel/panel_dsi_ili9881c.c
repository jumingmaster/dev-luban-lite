...
#define SLEEP_PIN  "PD.9"
#define RESET_PIN  "PD.12"
...
static int ili9881c_default_enable(struct aic_panel *panel)
{
    ...
    panel_dsi_dcs_send_seq(panel,0x0d,0x00);
    panel_dsi_dcs_send_seq(panel,0x0e,0x00);
    panel_dsi_dcs_send_seq(panel,0x0f,0x1D);
    panel_dsi_dcs_send_seq(panel,0x10,0x1D);
    panel_dsi_dcs_send_seq(panel,0x11,0x00);
    panel_dsi_dcs_send_seq(panel,0x12,0x00);
    panel_dsi_dcs_send_seq(panel,0x13,0x00);
    panel_dsi_dcs_send_seq(panel,0x14,0x00);
    ...
    panel_dsi_dcs_send_seq(panel,0x21,0x02);
    panel_dsi_dcs_send_seq(panel,0x22,0x00);
    panel_dsi_dcs_send_seq(panel,0x23,0x00);
    panel_dsi_dcs_send_seq(panel,0x24,0x00);
    panel_dsi_dcs_send_seq(panel,0x25,0x00);
    ...
    panel_dsi_dcs_send_seq(panel,0x34,0x04);
    panel_dsi_dcs_send_seq(panel,0x35,0x00);
     panel_dsi_dcs_send_seq(panel,0x36,0x00);//00
    panel_dsi_dcs_send_seq(panel,0x37,0x00);
    panel_dsi_dcs_send_seq(panel,0x38,0x3C);
    ...
    panel_dsi_dcs_send_seq(panel,0x3F,0x00);
    panel_dsi_dcs_send_seq(panel,0x40,0x00);
    panel_dsi_dcs_send_seq(panel,0x41,0x88);
    panel_dsi_dcs_send_seq(panel,0x42,0x00);
    panel_dsi_dcs_send_seq(panel,0x43,0x00);
    ...
    panel_dsi_dcs_send_seq(panel,0x61,0x15);
    panel_dsi_dcs_send_seq(panel,0x62,0x14);
    panel_dsi_dcs_send_seq(panel,0x63,0x0E);
    panel_dsi_dcs_send_seq(panel,0x64,0x0F);
    panel_dsi_dcs_send_seq(panel,0x65,0x0C);
    panel_dsi_dcs_send_seq(panel,0x66,0x0D);
    panel_dsi_dcs_send_seq(panel,0x67,0x06);
    panel_dsi_dcs_send_seq(panel,0x68,0x02);
    panel_dsi_dcs_send_seq(panel,0x69,0x07);
    panel_dsi_dcs_send_seq(panel,0x6a,0x02);
    panel_dsi_dcs_send_seq(panel,0x6b,0x02);
    panel_dsi_dcs_send_seq(panel,0x6c,0x02);
    panel_dsi_dcs_send_seq(panel,0x6d,0x02);
    ...
    panel_dsi_dcs_send_seq(panel,0x75,0x01);
    panel_dsi_dcs_send_seq(panel,0x76,0x00);
    panel_dsi_dcs_send_seq(panel,0x77,0x14);
    panel_dsi_dcs_send_seq(panel,0x78,0x15);
    panel_dsi_dcs_send_seq(panel,0x79,0x0E);
    panel_dsi_dcs_send_seq(panel,0x7a,0x0F);
    panel_dsi_dcs_send_seq(panel,0x7b,0x0C);
    panel_dsi_dcs_send_seq(panel,0x7c,0x0D);
    panel_dsi_dcs_send_seq(panel,0x7d,0x06);
    panel_dsi_dcs_send_seq(panel,0x7e,0x02);
    panel_dsi_dcs_send_seq(panel,0x7f,0x07);
    panel_dsi_dcs_send_seq(panel,0x80,0x02);
    panel_dsi_dcs_send_seq(panel,0x81,0x02);
    panel_dsi_dcs_send_seq(panel,0x82,0x02);
    panel_dsi_dcs_send_seq(panel,0x83,0x02);
    ...
    panel_dsi_dcs_send_seq(panel,0x84,0x0F);
    panel_dsi_dcs_send_seq(panel,0x85,0x0D);
    panel_dsi_dcs_send_seq(panel,0x32,0xAC);
    panel_dsi_dcs_send_seq(panel,0x8C,0x80);
    panel_dsi_dcs_send_seq(panel,0x3C,0xF5);
    panel_dsi_dcs_send_seq(panel,0xB5,0x07);
    panel_dsi_dcs_send_seq(panel,0x31,0x45);
    panel_dsi_dcs_send_seq(panel,0x3A,0x24);
    panel_dsi_dcs_send_seq(panel,0x88,0x33);
    panel_dsi_dcs_send_seq(panel,0xFF,0x98,0x81,0x01);
    panel_dsi_dcs_send_seq(panel,0x22,0x09);//09
    panel_dsi_dcs_send_seq(panel,0x31,0x00);
    panel_dsi_dcs_send_seq(panel,0x53,0x8A);
    panel_dsi_dcs_send_seq(panel,0x55,0xA2);
    panel_dsi_dcs_send_seq(panel,0x50,0x81);
    panel_dsi_dcs_send_seq(panel,0x51,0x85);
    panel_dsi_dcs_send_seq(panel,0x62,0x0D);

    panel_dsi_dcs_send_seq(panel,0xFF,0x98,0x81,0x01);

    panel_dsi_dcs_send_seq(panel,0xA0,0x00);
    panel_dsi_dcs_send_seq(panel,0xA1,0x1A);
    panel_dsi_dcs_send_seq(panel,0xA2,0x28);
    panel_dsi_dcs_send_seq(panel,0xA3,0x13);
    panel_dsi_dcs_send_seq(panel,0xA4,0x16);
    panel_dsi_dcs_send_seq(panel,0xA5,0x29);
    panel_dsi_dcs_send_seq(panel,0xA6,0x1D);
    panel_dsi_dcs_send_seq(panel,0xA7,0x1E);
    panel_dsi_dcs_send_seq(panel,0xA8,0x84);
    panel_dsi_dcs_send_seq(panel,0xA9,0x1C);
    panel_dsi_dcs_send_seq(panel,0xAA,0x28);
    panel_dsi_dcs_send_seq(panel,0xAB,0x75);
    panel_dsi_dcs_send_seq(panel,0xAC,0x1A);
    panel_dsi_dcs_send_seq(panel,0xAD,0x19);
    panel_dsi_dcs_send_seq(panel,0xAE,0x4D);
    panel_dsi_dcs_send_seq(panel,0xAF,0x22);
    panel_dsi_dcs_send_seq(panel,0xB0,0x28);
    panel_dsi_dcs_send_seq(panel,0xB1,0x54);
    panel_dsi_dcs_send_seq(panel,0xB2,0x66);
    panel_dsi_dcs_send_seq(panel,0xB3,0x39);
    panel_dsi_dcs_send_seq(panel,0xC0,0x00);
    panel_dsi_dcs_send_seq(panel,0xC1,0x1A);
    panel_dsi_dcs_send_seq(panel,0xC2,0x28);
    panel_dsi_dcs_send_seq(panel,0xC3,0x13);
    panel_dsi_dcs_send_seq(panel,0xC4,0x16);
    panel_dsi_dcs_send_seq(panel,0xC5,0x29);
    panel_dsi_dcs_send_seq(panel,0xC6,0x1D);
    panel_dsi_dcs_send_seq(panel,0xC7,0x1E);
    panel_dsi_dcs_send_seq(panel,0xC8,0x84);
    panel_dsi_dcs_send_seq(panel,0xC9,0x1C);
    panel_dsi_dcs_send_seq(panel,0xCA,0x28);
    panel_dsi_dcs_send_seq(panel,0xCB,0x75);
    panel_dsi_dcs_send_seq(panel,0xCC,0x1A);
    panel_dsi_dcs_send_seq(panel,0xCD,0x19);
    panel_dsi_dcs_send_seq(panel,0xCE,0x4D);
    panel_dsi_dcs_send_seq(panel,0xCF,0x22);
    panel_dsi_dcs_send_seq(panel,0xD0,0x28);
    panel_dsi_dcs_send_seq(panel,0xD1,0x54);
    panel_dsi_dcs_send_seq(panel,0xD2,0x66);
    panel_dsi_dcs_send_seq(panel,0xD3,0x39);
    panel_dsi_dcs_send_seq(panel,0x36,0xC0);//00
#endif
    /* CMD_Page 0 */
